...
val AppBackground = Color(0xFF0A1014)
val ElevatedSurface = Color(0xFF13181C)
val SearchSurface = Color(0xFF23282C)
val ComponentSurface = Color(0xFF20272B)
val IncomingBubble = Color(0xFF20272B)
val OutgoingBubble = Color(0xFF144D37)
val SelectedPill = Color(0xFF242625)
val PrimaryText = Color(0xFFF7F8FA)
val SecondaryText = Color(0xFF8D9599)
val BrandGreen = Color(0xFF21C063)
